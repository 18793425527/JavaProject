    ...
    <div class="content">
    	<div class="contentCenter">
    		...
    		<p style="font-size:15px;color:red">
    			<input type="radio" name="address" checked="checked" onclick="addShipaddress(1,'张三','上海市闵行区','18811012136')">
	    		tom
	    		江苏省苏州市
	    		12345678910
	    		(默认)
    		...
    		<div class="centerTop">
    			<b style="font-size:20px;">收货人信息</b>
		    		 	...
		    		 	<p style="font-size:15px;">
							收件人姓名：<input type="text" id='addName' value="tom" disabled  name="name"><br/><br/>
							收件人地址：<input type="text" id='addAdd' value="江苏省苏州市" disabled  name="address" ><br/><br/>
							收件人电话：<input type="text" id='addPhone' value="12345678910" disabled  name="tel" >
						</p>
    		...
    		<div class="bigDiv">
    			<div class="twoDiv">
    				<b>商家：briup自营</b>
							...
							<ul class="oneUL">
		    					<li>
		    						<img src="images/book_shopCart/book4.jpg" class="pic">
		    						<p>计算机&nbsp;&nbsp;JAVA核心技术&nbsp;&nbsp;</p>
		    						<p>¥ <font class="price">81.00</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span>共<font>1</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class="total"></font></span>
    		...
    		<div class="submit">
    			<span>应付金额：
    				...
    				<a id="confirm"><img src="images/21_03.png" style="cursor: pointer;" alt="" onclick="#"></img></a>
    			</span>
    		</div>
    	</div>
