	...
	<div class="container5">
    	<div class="cn5_top">
            <div class="cn5_top_x center01">
                ...
                <a href="#">${toViewBook.category.name }</a>
            </div>
            <div class="cn5_top_y center01">
            	<div id="demo" class="cn5topy_1">
                	<div id="small-box" class="cn5topy_imgview">
                    	...
                    	<img src="images/book_view/${toViewBook.image }"/>
                        <ul class="cn5topy_imglist">
                        	<li><a href="#"><img src="images/${toViewBook.image }"></a></li>
                ...
                <div class="cn5topy_2">
                	<h1 class="pro_title font15">${toViewBook.name }</h1>
                    <div class="pro_price">
                            <div class="pro_price_x">
                                <p> 价格：<b>￥ ${toViewBook.price }</b> <a href="#">(降价通知)</a></p>
                            </div>
                    ...
                    <div class="pro_buy">
                        ...
                        <div class="pro_addshop"> 
                        	<a href="AddShopCarServlet?bookId=${toViewBook.id }" onclick="addShopCart(${toViewBook.name})">加入购物车 </a>
                ...
                <!--内容-->
              	<div class="c5_b2_right_1 box">
                    ...
                    <div class="intro_pics">
                    	<img class="intro_pic" src="images/book_view/${toViewBook.image }">
                    </div>
                </div>
